...
export function ChangeType(): React.JSX.Element {
    ...
    return (
        <div>
            ...
            <div>{type === "multiple_choice_question" ? "Multiple Choice" : "Short Answer"} </div>
        </div>
    );
}

// The ChangeType component simulates another an editor for a quiz application that provides a way to change the type of a quiz question by pressing a button. 
